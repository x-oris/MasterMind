...
***
**MasterMind**, a minimized shell in **C Programming language**, interpreting logical operators **&&** with **||** and **Parenthesis** only for prioritization, parsing input, and executing commands, with integrated builtins such as ***echo***, ***export***, ***cd***, ***pwd***, ***env...*** along with expanding enverionment variables.
***

**Xoris's side in the project:**
